...
"use strict";
function ad_click(e,t,a,i,o,p,n,r,_,s,d,l,c,m,u,g){
if(!has_click[o]){
has_click[o]=!0;
var f=document.getElementById("loading_"+o);
...
if(has_click[o]=!1,f&&(f.style.display="none"),"5"==e)location.href="/mp/profile?source=from_ad&tousername="+t+"&ticket="+p+"&uin="+uin+"&key="+key+"&__biz="+biz+"&mid="+mid+"&idx="+idx+"&tid="+o;else{
if("105"==_&&l)return void Card.openCardDetail(l.card_id,l.card_ext,l);
if("106"==_&&l)return void(location.href=ParseJs.join(t,{
outer_id:l.outer_id
}));
...
if("104"==_&&l||-1!=t.indexOf("mp.weixin.qq.com/mp/ad_app_info")){
var n="",c="";
...
pos_0:[],
pos_1:[]
},ping_test_apurl_random=Math.random()<.3,ping_test_cmp_apurl_random=Math.random()<.01,innerHeight=window.innerHeight||document.documentElement.clientHeight,ad_engine=0;
if(adDatas.num>0){
...
var gid=gdt_a.dataset.gid,tid=gdt_a.dataset.tid,apurl=gdt_a.dataset.apurl,pos_type=adDatas.ads[pos_key].a_info.pos_type,gdt_area=el_gdt_areas[pos_key],offsetTop=gdt_area.offsetTop,adHeight=gdt_a.clientHeight,adOffsetTop=offsetTop+gdt_a.offsetTop;
...
if(ping_test_cmp_apurl_random&&!ping_cpm_apurl_obj.hasPing){
var rh=.5;
...
ping_cpm_apurl_obj.hasPing=!0,(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=28307_17_1&r="+Math.random();
...
if(o){
for(var p=o.adData,n=o.a_info,r=n.pos_type,_=o.ad_engine,s=0,d=i.length;d>s;++s)!function(e,t){
var a=i[e],o=a.dataset;
if(o){
var p=o.type,n=o.url,s=o.rl,d=o.apurl,l=o.tid,c=o.ticket,m=o.group_id,u=o.aid,g=o.pt;
...
f=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientWidth,
y=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientHeight,
ad_click(p,n,s,d,l,c,m,u,g,r,_,t,i,o,f,y),!1;
}
},!0);
}
}(s,p);
...
var l="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+_+"&pos_type="+r+"&r="+Math.random();
...
adData:p,
report_param:l,
task_ext_info:[p.adid,p.traceid,g,source,u,_].join("."),
via:[p.traceid,p.adid,g,source,u,_].join(".")
});
}
if("101"==p.pt){
...
via:[p.traceid,p.adid,g,source,u,_].join("."),
ticket:p.ticket,
appdetail_params:["&aid="+p.adid,"traceid="+p.traceid,"pkgname="+g,"source="+source,"type="+u,"engine="+_,"appuin="+biz,"pos_type="+r,"ticket="+p.ticket,"scene="+scene].join("&")
});
}
...
type:"post",
data:{
id_key_list:["1|1|"+m,"1|2|"+d,"1|3|"+s,"1|4|"+p,"1|5|"+g,"1|6|"+c,"1|7|"+u,"1|8|"+l].join(";")
}
}):Math.random()<.01&&a({
url:"/mp/report_cost",
type:"post",
