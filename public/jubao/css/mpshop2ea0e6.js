...
"use strict";
function e(t){
"undefined"!=typeof _&&_.log&&_.log(t);
}
function a(t,e){
o("http://mp.weixin.qq.com/mp/ad_report?action=follow&type="+t+e.report_param);
}
function n(n){
var o=n.btn,p=n.js_app_rating;
if(!o)return!1;
var f={},g=n.adData,j="",v="",k=g.md5sum,w="",h=n.pos_type||0;
if(function(){
...
i&&o&&i[0]&&o[0]&&(i=i[0],o=o[0],i.style.display="inline-block",s.addClass(i,a));
}
}(),"104"==g.pt){
var b=g.androiddownurl;
if(v=j=g.channel_id||"",b&&b.match){
var y=/&channelid\=([^&]*)/,x=b.match(y);
x&&x[1]&&(j=x[1],g.androiddownurl=b.replace(y,""));
}
j&&(j="&channelid="+j),n.via&&(w=["&via=ANDROIDWX.YYB.WX.ADVERTISE",n.via].join("."));
}
_.ready(function(){
"104"==g.pt&&(_.invoke("getInstallState",{
packageName:m
},function(t){
var a=t.err_msg;
e("getInstallState @yingyongbao : "+a);
var n=a.lastIndexOf("_")+1,i=a.substring(n);
1*i>=u&&a.indexOf("get_install_state:yes")>-1&&(c=!0);
}),_.invoke("getInstallState",{
packageName:g.pkgname
},function(t){
var a=t.err_msg;
e("getInstallState @"+g.pkgname+" : "+a);
var n=a.lastIndexOf("_")+1,i=a.substring(n);
1*i>=g.versioncode&&a.indexOf("get_install_state:yes")>-1&&(l=!0,o.innerHTML="已安装",
s.removeClass(o,"btn_download"),s.addClass(o,"btn_installed"));
})),i.on(o,"click",function(i){
if(e("click @js_app_action"),l&&"104"==g.pt)return!1;
var o=function(){
if("104"==g.pt){
if(c)return a(24,n),void(location.href="tmast://download?oplist=1;2&pname="+g.pkgname+j+w);
a(25,n);
var e=g.url;
if(e&&(0==e.indexOf("http://mp.weixin.qq.com/tp/")||0==e.indexOf("https://mp.weixin.qq.com/tp/"))){
var i=t("biz_common/utils/url/parse.js");
return e=i.join(e,{
auto:"1"
}),void(location.href=e);
}
return void(location.href="http://mp.weixin.qq.com/mp/ad_app_info?t=ad/app_detail&app_id="+g.app_id+(n.appdetail_params||"")+"&channel_id="+v+"&md5sum="+k+"&auto=1#wechat_redirect");
}
if("103"==g.pt){
a(23,n);
var o="http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(g.appinfo_url)+"&uin="+uin+"&ticket="+(n.ticket||window.ticket);
_.invoke("downloadAppInternal",{
...
if(!f[g.traceid]){
f[g.traceid]=!0;
var s,p,m,u,b=!!i&&i.target;
b&&(s=r.getX(b,"js_ad_link extra_link")+i.offsetX,p=r.getY(b,"js_ad_link extra_link")+i.offsetY,
m=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientWidth,
u=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientHeight),
d({
type:g.type,
report_type:2,
click_pos:0,
...
var i=t("biz_common/dom/event.js"),o=t("biz_common/utils/report.js"),r=(t("biz_wap/utils/ajax.js"),
t("biz_wap/utils/position.js")),s=t("biz_common/dom/class.js"),l=!1,p=t("appmsg/a_report.js"),d=p.AdClickReport,_=t("biz_wap/jsapi/core.js"),c=("https:"==top.location.protocol?5:0,
...
var n=e.tid,i=e.type,o=e.url,a=e.rl;
if(!l[n]){
l[n]=!0;
var c,_,d,u,j=!!t&&t.target;
j&&(c=r.getX(j,"js_ad_link extra_link")+t.offsetX,_=r.getY(j,"js_ad_link extra_link")+t.offsetY,
d=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientWidth,
u=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientHeight),
p({
type:i,
report_type:2,
...
-1!=p.indexOf("ok")?(d.style.display="inline-block",m.style.display="none",r=i.is_appmsg?9:4):"add_contact:added"==p?r=i.is_appmsg?7:2:"add_contact:cancel"==p?r=i.is_appmsg?8:3:(--s,
...
e(i.is_appmsg?10:5,t),c.invoke("addContact",{
scene:scene,
webtype:"1",
username:i.usename
},function(t){
...
{
var o=t("biz_common/dom/event.js"),a=t("biz_common/utils/report.js"),s=t("appmsg/a_report.js"),p=s.AdClickReport,r=(t("biz_wap/utils/ajax.js"),
...
function i(t){
var i=t.adData,a=t.pos_type||0,s=i.tid,_=i.type,l=(i.adid,i.outer_id),m=i.url,c=i.rl,d={};
t.report_param=t.report_param||"";
var j=t.btn;
if(j){
o.on(j,"click",function(i){
if(!d[s]){
d[s]=!0;
var o,j,u,b,k=!!i&&i.target;
k&&(o=r.getX(k,"js_ad_link extra_link")+i.offsetX,j=r.getY(k,"js_ad_link extra_link")+i.offsetY,
u=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientWidth,
b=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientHeight),
n({
type:_,
report_type:2,
click_pos:0,
...
d[s]=!1,e(61,t),location.href=p.join(m,{
outer_id:l
});
});
}
...
var o=t("biz_common/dom/event.js"),a=t("biz_common/utils/report.js"),s=t("appmsg/a_report.js"),n=s.AdClickReport,r=(t("biz_wap/utils/ajax.js"),
