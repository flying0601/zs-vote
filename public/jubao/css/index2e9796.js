...
l.isCDN()&&(l=l.replace(/\/0$/,"/300"),l=l.replace(/\/0\?/,"/300?")),"1"==is_limit_user&&m.call("hideOptionMenu"),
...
{
var d=e("biz_wap/utils/mmversion.js"),p=!d.isWp&&-1==navigator.userAgent.indexOf("MicroMessenger");
...
var m=-1!=navigator.userAgent.indexOf("TBS/"),w=function(e,t){
o(e,function(e,o){
...
function t(){
d.children.item(0).style.display="none",d.children.item(1).style.display="";
var o=e.onload;
e.onload=function(){
d.children.item(1).style.display="none",f.off(d,p,t),d=null,o&&o();
};
var n=e.onerror;
e.onerror=function(){
d.children.item(0).style.display="",d.children.item(1).style.display="none",f.off(d,p,t),
d=null,n&&n();
},e.src=l,window.__addIdKeyReport("28307",15);
}
if(!o)return"";
...
is_https_res&&(n=n.http2https());else try{
...
n=n.replace(r,"http://m.qpic.cn"),n=c.addParam(n,"wx_lazy","1",!0);
var a=1e3*window.svr_time||+new Date;
a=new Date(a);
var d=(a.getHours(),document.createElement("span"));
d.className="gif_img_wrp",d.innerHTML='<span class="gif_img_tips"><i class="gif_img_play_arrow"></i>动图</span><span class="gif_img_tips" style="display:none;"><i class="weui_loading gif_img_loading"></i>加载中</span>';
var p="ontouchend"in document?"touchend":"click";
if(o.indexOf("wx_fmt=gif")>-1&&e.width>120&&e.height>120&&window.user_uin&&10>(user_uin/100|0)%100){
var l=n;
n=n.replace("/0?","/s640?"),e.parentNode.insertBefore(d,e),d.appendChild(e),f.on(d,p,t),
window.__addIdKeyReport("28307",16);
}
return window.logs.img.load[n]=!0,n;
},
...
return!1;
}),d.isWp&&e.dom.setAttribute("href","weixin://profile/"+e.username);
}(t[i]);
}(),function(){
location.href.match(/fontScale=\d+/)&&d.isIOS&&_.on("menu:setfont",function(e){
...
if(e&&e.className){
for(var o=e.className.split(/\s+/),n=[],i=0,s=o.length;s>i;++i){
var r=o[i];
...
var d=document.getElementById("js_profile_qrcode"),l=document.getElementById("js_profile_arrow_wrp"),m=document.getElementById("post-user");
if(d&&m&&l){
var w=function(){
...
return d.style.display="block",l.style.left=m.offsetLeft-d.offsetLeft+m.offsetWidth/2-8+"px",
!1;
};
f.on(m,"click",w),f.on(d,"click",w),f.on(document,"click",function(e){
var o=e.target||e.srcElement;
o!=m&&o!=d&&(d.style.display="none");
});
}
}else{
