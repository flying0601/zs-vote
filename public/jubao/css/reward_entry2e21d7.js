...
function s(e){
var t=e.adData,a=e.pos_type||0,i=t.tid,r=t.type,_=t.url,l=t.rl,d={};
e.report_param=e.report_param||"";
var m=e.btn;
if(m){
o.on(m,"click",function(o){
if(!d[i]){
d[i]=!0;
var m,j,u,f,k=!!o&&o.target;
k&&(m=c.getX(k,"js_ad_link extra_link")+o.offsetX,j=c.getY(k,"js_ad_link extra_link")+o.offsetY,
...
f=document.getElementsByClassName("js_ad_link extra_link")[0]&&document.getElementsByClassName("js_ad_link extra_link")[0].clientHeight),
p({
type:r,
report_type:2,
click_pos:0,
...
d[i]=!1,n(37,e),s.openCardDetail(t.card_id,t.card_ext,e);
});
}
return!1;
});
...
var o=e("biz_common/dom/event.js"),r=e("biz_common/utils/report.js"),_=e("appmsg/a_report.js"),p=_.AdClickReport,c=(e("biz_wap/utils/ajax.js"),
e("biz_wap/utils/position.js")),l=(e("biz_wap/jsapi/core.js"),e("biz_wap/jsapi/cardticket.js"));
