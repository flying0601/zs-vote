  ...
  <div class='details-box'>
    <div class=""
      ...
      <div class="swiper-container"
           v-if="giftvote && giftvote.topimg && giftvote.topimg.pic_1">
        ...
        <div style="width: 100%; text-align: left; padding-bottom: 20px;">
            ...
            <div style="padding: 0px 0px 10px 10px; margin-top: -10px;">
              ...
              <div style="margin-top:5px">
                <div v-if="voteuser.details"
                     v-html="'自我介绍:'+voteuser.details">
                </div>
              </div>
              <div v-if="giftvote.xs_js">
                <p style="margin-top:5px"
                   v-html="giftvote.xs_js+'：'+voteuser.introduction">
                </p>
          ...
          <div style="width: 100%; margin-left: 0px; text-align: center;"
            ...
            <div style="margin-top: -10px;"
                 class="zlb"
                 id="pcount">
              <span id="votenum2">{{playerCensus && playerCensus.votenum ? playerCensus.votenum : voteuser.votenum }}</span>票
            </div>
            <div class="zlb"
...
export default {
  ...
  components: {
    VHb
    // VHb (resolve) {
    //   require(['@/components/v1/v-hb.vue'], resolve)
    // }
  },
  data () {
    return {
