<template>
  <div class=''>
      ...
      <span>
        ...
        <div class="divmain11 clearfix bg-purple3 bg-blue3">
          <input type="text"
                 ...
                 class="inputtxt">
          <div class="divsub"
               @click="clickSearch()"><i class="glyphicon glyphicon-search"></i>&nbsp;&nbsp;搜索</div>
        </div>
    ...
    <div class="divmain10 pd-10 bg-purple4 bg-blue4">
      ...
      <div class="divcon"
           v-html="html"
           v-lazy-container="{ selector: 'img' ,error: 'resource/common/nodata.png', loading: 'resource/common/loading.gif' }">
