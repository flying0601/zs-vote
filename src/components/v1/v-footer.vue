<template>
  <div>
    ...
    <div class="footer">
      <ul>
        <li><a @click="clickNav('VIndex')"
             :class="{on: currentComponent == 'VIndex'}">
            <div class='nav'>
        ...
        <li><a @click="clickNav('Vrank')"
             :class="{on: currentComponent == 'Vrank'}">
            <div class='nav'>
        ...
        <li><a @click="clickNav('VAward')"
             :class="{on: currentComponent == 'VAward'}">
            <div class='nav'>
              <div class='is ispr iconfont icon-jiangpin'></div>
              <p>奖品</p>
            </div>
          </a></li>
        <li v-if="!meData"><a @click="clickNav('VSignup')"
             :class="{on: currentComponent == 'VSignup'}">
            <div class='nav'>
        ...
        <li v-else>
          <a @click="clickNav('VDetails')"
             :class="{on: currentComponent == 'VDetails' && meOpenid==voteuser.openid}">
            <div class='nav'>
              <div class='ic ispr iconfont icon-wode '></div>
              <p>我的</p>
            </div>
          </a>
        </li>
        <li><a @click="clickNav('Vcomplaint')"
             :class="{on: currentComponent == 'Vcomplaint' }">
            <div class='nav'>
              <div class='is ispr'
                   id="zanzhu2"
                   :style="`background-image: url('app/WeChat/GiftVote/img/ts.png');`"></div>
              <p>投诉</p>
            </div>
          </a></li>
      </ul>
